# utils/export/export_internal_docx_fancy.py
...
def export_internal_docx_fancy(df, proposal_text, buffer, user="Cameron Rodrigues", firm="Procyon Partners", logo_path=None):
    doc = Document()
    ...
    # Title
    title = doc.add_paragraph("Internal Proposal")
    ...
    doc.add_paragraph("Detailed Analysis", style="Heading 1")
    ...
    disclaimer = doc.add_paragraph(
        "This proposal was generated automatically by FidSync and should be reviewed manually for internal accuracy."
    )
