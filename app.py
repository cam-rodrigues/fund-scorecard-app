...
# === Welcome Page ===
    ...
    .tw1 { animation: typing1 3s steps(50, end) 0s forwards, blink 0.75s step-end infinite; width: 0; }
    .tw2 { animation: typing2 3s steps(50, end) 3.2s forwards, blink 0.75s step-end infinite; width: 0; }
    .tw3 { animation: typing3 3s steps(50, end) 6.4s forwards, blink 0.75s step-end infinite; width: 0; }
    .tw4 { animation: typing4 3s steps(50, end) 9.6s forwards, blink 0.75s step-end infinite; width: 0; }
    ...
    @keyframes blink {
        ...
        50% { border-color: #1a2a44 }
    }
    </style>

    <div class="typewriter-container"><div class="tw-line tw1">Welcome to FidSync Beta</div></div>
    <div class="typewriter-container"><div class="tw-line tw2">Your streamlined toolkit for fund analysis</div></div>
    <div class="typewriter-container"><div class="tw-line tw3">Compare scorecards, scan articles, and more</div></div>
    <div class="typewriter-container"><div class="tw-line tw4">Select a tool from the sidebar to get started</div></div>
    """, unsafe_allow_html=True)
